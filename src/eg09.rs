/*
This is just a translation to Rust of lesson 6 of Will Usher's SDL tutorial.
See
...
fn main() {
    ...
    let window  = match video_ctx.window("eg09", SCREEN_WIDTH, SCREEN_HEIGHT)
    ...
    let font = match ttf_ctx.load_font(&Path::new("res/DroidSans.ttf"), 64) {
        Ok(font) => font,
